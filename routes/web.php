...
//Route for loadregister and studentRgister
Route::get('/register',[AuthController::class,'loadRegister']);
Route::post('/register',[AuthController::class,'studentRegister'])->name('studentRegister');


//inner function for login retutn redirect
...
//to specify the route eg: admin route and student route
//for checkAdmin
